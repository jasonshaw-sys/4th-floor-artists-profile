  ...
  const membershipBanner = () => {
    ...
    if (profile.membership_status === 'expired') {
      return (
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-4 flex items-center justify-between">
          ...
          <a href="https://www.4thfloorartists.com/store/membership" target="_blank" className="bg-red-600 text-white text-xs px-4 py-2 rounded-lg font-medium hover:bg-red-700">
            Renew Now
          </a>
        </div>
      )
    ...
    return (
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4 flex items-center justify-between">
        ...
        <a href="https://www.4thfloorartists.com/store/membership" target="_blank" className="bg-black text-white text-xs px-4 py-2 rounded-lg font-medium hover:bg-gray-800">
          Buy Membership
        </a>
      </div>
    )
